Rewrite the opening of this script five different ways.

The first thirty seconds decide whether anybody watches the other ten minutes. This is the highest-leverage text in the whole video, which is why it gets its own pass.

--- CURRENT OPENING (first ~30 seconds) ---
{opening}
--- END ---

--- FACTS AVAILABLE (you may not introduce any claim that is not here) ---
{facts}
--- END ---
